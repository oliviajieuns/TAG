...
setting \(\lambda=0\). The multiplicative gate is not a binary
accept--reject rule: it continuously attenuates each candidate
according to its estimated reliability, while the two dynamic terms
determine its usefulness to the evolving model.
