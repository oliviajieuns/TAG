...
Alignment contract (verified against ``tag.data.sft_prompts.tokenize_alpaca``):
...
def compute_pool_token_losses(
    ...
    *,
    ...
    This is :func:`tag.core.reliability.compute_pool_loss` without the final
    ...
    if q <= 0:
        ...
        if null_corrected:
            ...
            raise ValueError(
                ...
                f"calibration_target_pct or lower selection.tag.target_zero_rate."
            )
        logger.warning(
    ...
    *,
    ...
    if cfg.null_correction and cfg.null is None:
        raise ValueError(
            ...
            "selection.tag.gate_ref_file at it, or set selection.tag.null_correction: "
...
def compute_gate(
    ...
    *,
    ...
    deliberate and matches ``tag.core.reliability``: the clamp in Eq. 6 is
...
def resolve_scale(
    ...
    *,
    ...
    logger.warning(
        ...
        "dependence; pass selection.tag.gate_scale or selection.tag.gate_ref_file for "
        "reported runs.", s,
    )
    return max(s, 1e-6)
