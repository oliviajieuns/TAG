...
def tokenize_alpaca(
    ...
    *,
    ...
    return {
        ...
        # tag.core.reliability.completeness_from_dataset. Must be computed
...
def gsm8k_generation_prefix(
    ...
    Toggled at eval time via `TAG_GSM8K_USE_SFT_WRAP=1`; default OFF
...
def humaneval_generation_prefix(
    ...
    + a body. ``_extract_body_after_signature`` in tag.evals.humaneval
...
def mbpp_generation_prefix(
    ...
    `tag.evals.mbpp` then cut at the first `\\n[DONE]` or hallucinated
